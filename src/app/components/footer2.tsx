                ...
                <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-5 gap-7 md:lg:gap-2 md:lg:font-normal font-light">
                    <div>
                        ...
                        <ul className="space-y-2 text-white">
                            ...
                            <li>
                                <Link href="" className=" hover:text-[gray] text-[14px] leading-[18.9px] transition-all">New York City</Link>
                            </li>
                            <li>
                                <Link href="" className=" hover:text-[gray] text-[14px] leading-[18.9px] transition-all">United States of America</Link>
                            </li>
                            <li>
                                <Link href="" className=" hover:text-[gray] text-[14px] leading-[18.9px] transition-all">432 34</Link>
                            </li>
                        </ul>
                    </div>
