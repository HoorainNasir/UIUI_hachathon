    ...
    return (
        <footer className=" bg-[#2A254B]  pt-12 pb-3 px-[10px] font-sans tracking-wide relative">
            <div className="max-w-screen-xl mx-auto">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 font-normal">
                    <div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li>
                                <Link href="" className=" hover:text-[gray] text-[14px] leading-[18.9px] transition-all">Furniture</Link>
                            </li>
                            <li>
                                <Link href="" className=" hover:text-[gray] text-[14px] leading-[18.9px] transition-all">Homeware</Link>
                            </li>
                            <li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li>
                                <Link href="" className=" hover:text-[gray] text-[14px] leading-[18.9px] transition-all">Vacancies</Link>
                            </li>
                            <li>
                                <Link href="" className=" hover:text-[gray] text-[14px] leading-[18.9px] transition-all">Contact us</Link>
                            </li>
                            <li>
                                <Link href="" className=" hover:text-[gray] text-[14px] leading-[18.9px] transition-all">Privacy</Link>
                            </li>
                            <li>
                    ...
                    <div>
                        <h1 className="font-normal text-[16px] leading-[19.68px]">
                        Join our mailing list
                        </h1>
                        <div className="flex my-6 w-full">
                            <input type="email" placeholder="your@email.com" className="bg-gray-200 py-3 px-5 text-base w-full h-[56px] outline-none" />
                            <button className="bg-white hover:bg-[gray] text-black py-[10px] px-[12px] text-sm h-[56px] w-[100px]">Sign in</button>
                        </div>
                    </div>
