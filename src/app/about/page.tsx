...
export default function About(){
    return(
        <div>
            <Banner/>
            <D_Nav/>
            <div className="w-full mx-[80px] flex  my-[60px]">
                <h1 className="text-black font-sans font-normal text-4xl mr-[250px]">
                A brand built on the love of craftmanship, <br/>
                quality and outstanding customer service
                </h1>

                <Link href={""}>
            <button className="text-black bg-[#f9f9f9] w-[192px] h-[56px] px-[32px] py-[16px] text-sm">
                View our products</button></Link>
            </div>

            <div className="w-full px-[80px] py-[60px] flex gap-2">
                <div className="w-[600px] h-[450px] font-sans text-white bg-[#2A254B] px-[40px]">
                    ...
                    <Link href={""}>
            <button className="text-white mt-[180px] bg-[#4b435a] w-[192px] h-[56px] px-[32px] py-[16px] text-sm">
                View collection</button></Link>
                </div>
                
                <div className="w-[600px] h-[450p">
